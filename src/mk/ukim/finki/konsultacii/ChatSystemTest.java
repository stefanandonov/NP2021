...
class ChatSystem {
    ...
    public void register(String user){
        ...
        Comparator<ChatRoom> roomComparator = Comparator.comparing(ChatRoom::numUsers)
                .thenComparing(ChatRoom::getName);
        Optional<ChatRoom> optional = rooms.values().stream().min(roomComparator);
        optional.ifPresent(chatRoom -> chatRoom.addUser(user));
    }
